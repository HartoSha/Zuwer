...
?>
            ...
            <div class="main-container">
                ...
                <div class="price-wrapper">
                        <div class="purchase-form">
                            <!-- <span class="price">Цена: <span class="price__value">7845.65</span> $</span>
                            <div class="quantity-wrapper">
                                <span class="quantity">Количество: </span>
                                <input class="quantity__value entry" type="number" min="1" max="100" value="1">
                            </div>
                            <button class="buy">Купить</button> -->
                            <!-- кнопка для админестратора-->
                            <a class="" href="/admin/editPage/<?php print $productInfo["id_product"] ?>"><button class="change">Изменить</button></a>
                            <!-- кнопка для админестратора -->
                        </div>
                    </div>
                <div class="description-wrapper">
                    <span class="description">Описание:</span>
                    <span class="content-description">Ручка изготовлена из высокласных материалов</span>
                </div>
            </div>
        </div>
    </main>
                ...
                <div class="purchase-form-modal__inputs">
                    ...
                    <div class="bottom-row">
                        <label class="purchase-form-modal__quantity-container">
                            ...
                            <input class="purchase-form-modal__quantity" type="number" min="1" max="100" value="1">
                        </label>
    ...
    <script src="../js/priceToQuantityLinker.js"></script>
<?php
